...
# Existing worker/page code resolves these names from desktop_ui_trade globals.
# Swapping them here upgrades the feature without duplicating the working UI.
trade.analyze_trade_plan = analyze_trade_plan_v2
trade.build_trade_plan_snapshot = build_trade_plan_snapshot_v2


class TradeTickerMemoryPageV2(trade.TradeTickerMemoryPage):
    def __init__(self, repo: trade.stats.market.cal.ai.base.DashboardRepository) -> None:
        super().__init__(repo)
...
# MainWindow construction resolves the Ticker Memory class from this base global.
trade.stats.market.cal.ai.base.TickerMemoryPage = TradeTickerMemoryPageV2
