...
def analyze_automatic_trade_plan(
    ...
    *,
    ...
    request_snapshot["automatic_chart_context"] = {
        ...
        "bars": bars,
        "interpretation": (
            "The image is rendered by TrendVisionAI from these same-feed bars. It is not a third-party chart, "
    ...
    auto_instructions = (
        ...
        "- Do NOT invent or switch to a different setup just because another chart pattern looks interesting. Decide whether the recognized setup is executable now.\n"
        ...
        "- Respect plan_constraints, especially the anti-chase maximum entry extension.\n"
        ...
        "- Use the image and bar list for chart structure; exact current planning price/quote still comes from alpaca_market_context.\n"
